      ...
      <div className = "w-screen xl:h-[150vh]">
        ...
        <div className = "w-screen h-[60vh] mt-20 flex justify-center ">
          ...
          <div className = "w-[24rem] h-[24rem] mt-20">
            ...
            <div className="mt-8 ml-8 w-full md:w-[17.4rem] h-16 flex justify-center items-center">
              <button onClick = {incrementButton} className="border-primary border-[15px] hover:border-gray-300 active:border-gray-400 outline outline-1 outline-black rounded-full">
                <FaPlus />
              </button>
              <div className = "ml-8 outline outline-1 outline-black w-[2.5rem] h-[2.5rem] flex justify-center items-center ">{quantity}</div>
              <button onClick = {decrementButton} className="ml-8 border-primary border-[15px] hover:border-gray-300 active:border-gray-400 outline outline-1 outline-black rounded-full">
                <FaMinus /> </button>
              </div>
            <button onClick = {addToCart} className = "text-white mt-8 ml-8 py-1.5 px-24 bg-[#BD9A48] shadow-2xl hover:bg-[#caae6c] active:bg-[#d7c291]">Add to cart</button>
          </div>
        </div>
